                ...
                <ul>
                  {imagesByDate[hoveredDate].map((image) => (
                    <li className="watering-tooltip-item" key={image.id}>
                      ...
                      {isLoggedIn ? (
                        <button className="watering-delete-btn" onClick={() => openDeleteModal({ type: "image", id: image.id })}>
                          <FontAwesomeIcon icon={faTrash} />
                        </button>
                      ) : (
                        <button
                          className="watering-delete-btn"
                          onClick={() => toast.warning("You must be logged in to delete uploaded image events.")}
                        >
                          <FontAwesomeIcon icon={faTrash} />
                        </button>
                      )}
                ...
                <ul>
                  {notesByDate[hoveredDate].map((note) => (
                    <li className="watering-tooltip-item" key={note.id}>
                      ...
                      {isLoggedIn ? (
                        <button className="watering-delete-btn" onClick={() => openDeleteModal({ type: "note", id: note.id })}>
                          <FontAwesomeIcon icon={faTrash} />
                        </button>
                      ) : (
                ...
                <ul>
                  {seasonEventsByDate[hoveredDate].map((event) => (
                    <li className="watering-tooltip-item" key={event.id}>
                      ...
                      {isLoggedIn ? (
                        <button className="watering-delete-btn" onClick={() => openDeleteModal({ type: "season", id: event.id })}>
                          <FontAwesomeIcon icon={faTrash} />
                        </button>
                      ) : (
                        <button className="watering-delete-btn" onClick={() => toast.warning("You must be logged in to delete season events.")}>
                          <FontAwesomeIcon icon={faTrash} />
                        </button>
                      )}
                    </li>
